...
def ele_replace!(array, hash)
    array.each_with_index {|e, i| array[i] = hash[e] if hash.key?(e)}
end
...
p result_1.object_id == array_1.object_id # => 70119569670520
...
p result_2.object_id == array_2.object_id # => 70119569668160
