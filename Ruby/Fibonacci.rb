...
previous two elements. For example the first 6 fibonacci
numbers are 1, 1, 2, 3, 5, 8. Write a method fibonacci that takes in a number
...
def fibonacci(length)
  ...
  when 1
    ...
    res = [1, 1]
    (0 .. length - 3).map {|i| res << res[i .. i+2].sum}
    return res
  end
end
